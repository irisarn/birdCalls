...
// // function to display Bird Call sightings
// function tableDisplay(Bird_Calls) {
//     var tbody = d3.select("tbody");
//     birdRecord.forEach((birdRecord) => {
//       var row = tbody.append("tr");
//       Object.entries(birdRecord).forEach(([key, value]) => {
...
//   // initial display of all bird calls
...
//     deleteTbody();
//     var nameInput = d3.select("#datetime").property("value");
    
//     if (NameInput.trim() === "" ) {
//       // display the whole database if the name field has no name
//       var filteredData = tableData;
//     } else {
//       // otherwise, display the filtered dataset  
//       var filteredData = tableData.filter(Bird_Calls => 
//         Bird_Calls.datetime === dateInput.trim());
//     };
